...
export const metadata: Metadata = { title: 'Live Photos', description: 'Photos of Rock Steady performing live at Phoenix-area venues and events.', alternates: { canonical: '/photos' } };
