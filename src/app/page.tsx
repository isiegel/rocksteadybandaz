        ...
        <section id="booking" className="px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-8 border-y border-white/12 py-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div className="border border-white/12 bg-[#101010] p-6">
              ...
              <p className="mt-3 leading-7 text-white/70">
                The current public handle is @rocksteadybandaz. Use it for
                booking questions, show updates, and photo swaps.
              </p>
              <a
                href="https://www.facebook.com/rocksteadybandaz"
                target="_blank"
                rel="noreferrer"
                className="mt-6 inline-flex rounded-full bg-[#37d67a] px-6 py-3 text-sm font-black uppercase text-[#06140b] transition hover:bg-[#ffcf33] focus:outline-none focus:ring-2 focus:ring-[#ffcf33]"
              >
                Message on Facebook
              </a>
            </div>
