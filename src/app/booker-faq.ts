...
export const bookerFaqs: BookerFaq[] = [
  {
    ...
    answer:
      'Yes — we bring our own [professional PA](/#sound) and run it ourselves: full, clear, and loud without turning to mud. If your room has house production, we are happy to coordinate with your sound team instead. The stage plot and input list are available on this page.',
