...
export default function MusicPage() { return <><ShrinkingHeader /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(videoStructuredData).replace(/</g, '\\u003c') }} /><main className="min-h-screen bg-[#050505] pb-20 pt-36 text-white"><section className="px-4 sm:px-6 lg:px-8"><div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center"><div><p className="text-sm font-black uppercase text-(--rock-steady-red)">Music &amp; video</p><h1 className="mt-3 text-5xl font-black leading-tight sm:text-6xl">Songs people actually sing.</h1><p className="mt-5 text-lg leading-8 text-white/72">Classic rock, throwback favorites, dance-floor staples, and closing-time choruses - played like a real band in a real room.</p></div><div className="overflow-hidden border border-white/12 bg-black"><VideoEmbed videoId={siteConfig.video.youtubeId} title="Rock Steady live performance video" /></div></div></section>
