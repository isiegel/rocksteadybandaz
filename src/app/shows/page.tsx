...
export default function ShowsPage() {
  return <><ShrinkingHeader /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(eventGraph).replace(/</g, '\\u003c') }} /><main className="min-h-screen bg-[#050505] px-4 pb-20 pt-36 text-white sm:px-6 lg:px-8"><section className="mx-auto max-w-7xl">
